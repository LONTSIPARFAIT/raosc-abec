...
<header class="border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md sticky top-0 z-50 transition-all duration-300">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
            <Link href="/" class="-m-1.5 p-1.5 flex items-center gap-3 group">
        ...
        <div class="hidden lg:flex lg:gap-x-10 items-center">
            <Link href="/" class="text-sm font-semibold leading-6 text-zinc-900 dark:text-zinc-100 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                Accueil
            </Link>
            <Link href="/rao" class="text-sm font-semibold leading-6 text-zinc-900 dark:text-zinc-100 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                Organisations
            </Link>
            <Link href="/posts" class="text-sm font-semibold leading-6 text-zinc-900 dark:text-zinc-100 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                Actualités
            </Link>
            <Link href="/about" class="text-sm font-semibold leading-6 text-zinc-900 dark:text-zinc-100 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                À propos
            </Link>
            <Link href="/contact" class="text-sm font-semibold leading-6 text-zinc-900 dark:text-zinc-100 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                Contact
            </Link>
        </div>
