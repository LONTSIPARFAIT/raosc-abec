            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-zinc-900 dark:text-white flex items-center gap-3">
                        <Bell class="w-6 h-6 text-[#008751]" />
                        Vos Notifications
                    </h1>
                ...
                <button 
                    @click="markAllAsRead"
                    class="flex items-center gap-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 px-4 py-2 rounded-xl text-sm font-bold text-zinc-600 hover:text-[#008751] hover:border-[#008751]/30 transition-all shadow-sm"
                >
                    ...
                    >
                        <div class="flex items-start gap-4 flex-grow min-w-0">
                            <div 
                                ...
                                :class="!notif.read_at ? 'bg-[#008751]/10 text-[#008751] border-[#008751]/20' : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-500 border-zinc-200 dark:border-zinc-700'"
                            >
                                <Bell v-if="!notif.type.includes('Approved')" class="w-5 h-5" />
                                <CheckCircle2 v-else class="w-5 h-5" />
                            </div>
                            <div>
                                <h3 class="text-sm font-bold text-zinc-900 dark:text-white" :class="!notif.read_at ? 'text-[#008751]' : ''">
                        ...
                        <div class="shrink-0 flex items-center">
                            <button 
                                ...
                                class="h-8 w-8 rounded-full bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 shadow-sm flex items-center justify-center text-zinc-400 hover:text-[#008751] hover:border-[#008751]/30 transition-all custom-tooltip group relative"
