    ...
    <component :is="isPublic ? PublicLayout : AppLayout">
        ...
        <div class="relative bg-zinc-950 py-32 sm:py-48 px-6 text-center overflow-hidden">
            ...
            <div class="relative text-center max-w-4xl mx-auto">
                <span class="text-raosc-green font-bold tracking-[0.2em] text-[10px] mb-4 block uppercase leading-none">Annuaire des OSC Africaines</span>
                <h1 class="text-4xl sm:text-7xl font-extrabold text-white mb-8 tracking-tight leading-none">
                    Le Réseau du <span class="text-raosc-green">Changement</span>
                </h1>
            ...
            <Card class="bg-white dark:bg-zinc-900 shadow-xl border-zinc-200 dark:border-zinc-800 rounded-3xl">
                <CardContent class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="relative group">
                            ...
                            <input 
                                ...
                                class="w-full pl-10 pr-4 py-3 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 focus:ring-2 focus:ring-raosc-green/20 focus:border-raosc-green outline-none text-sm transition-all dark:text-white"
                            >
                        </div>
                        ...
                        <div class="relative group">
                            ...
                            <select 
                                ...
                                class="w-full pl-10 pr-10 py-3 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 focus:ring-2 focus:ring-raosc-green/20 focus:border-raosc-green outline-none appearance-none text-sm dark:text-white"
                            >
                    ...
                    <div v-if="searchQuery || selectedCategory || selectedCity || selectedCountry" class="mt-4 flex items-center justify-between">
                        <span class="text-[11px] font-bold text-raosc-green bg-raosc-green/5 px-3.5 py-1.5 rounded-lg border border-raosc-green/10 tracking-tight">
                            {{ organizations.total }} résultats trouvés
                        </span>
                        <button @click="resetFilters" class="text-xs font-semibold text-zinc-500 hover:text-raosc-green transition-colors">
            ...
            <div class="mt-16 flex justify-center" v-if="organizations.last_page > 1">
                <nav class="flex items-center gap-1 bg-white dark:bg-zinc-900 p-1.5 rounded-2xl shadow-lg border border-zinc-100 dark:border-zinc-800">
                    <Link v-for="link in organizations.links" :key="link.label" :href="link.url || '#'" 
                          ...
                          :class="link.active ? 'bg-raosc-green text-white' : 'text-zinc-500 hover:bg-zinc-50 dark:hover:bg-zinc-800'">
